...
if(TK_FOUND)
  ...
  set(tk_cmake_args
    -D CMAKE_INSTALL_PREFIX:PATH=${CMAKE_INSTALL_PREFIX}/tk/${TK_VERSION}
  ...
  if (DEFINED TK_SOURCE_DIR)
    ExternalProject_Add(tk
      ...
      CMAKE_ARGS ${tk_cmake_args}
      CONFIGURE_COMMAND ./unix/configure --prefix=${CMAKE_INSTALL_PREFIX}/tk/${TK_VERSION} 
  ...
  list(APPEND opencascade_dependencies "tk")
endif()

# add TK to OpenCascade
list(APPEND opencascade_cmake_args "-D 3RDPARTY_TK_DIR=${TK_DIR}")
