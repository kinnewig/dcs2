...
find_path(SUITESPARSE_INCLUDE_DIR NAMES umfpack.h
          HINTS ${SUITESPARSE_DIR}/include ${CMAKE_INSTALL_PREFIX}/suitesparse/${SUITESPARSE_VERSION}/include/suitesparse/
          PATHS ${PC_SUITESPARSE_INCLUDEDIR} ${PC_SUITESPARSE_INCLUDE_DIRS})

find_library(SUITESPARSE_LIBRARY NAMES libumfpack${CMAKE_SHARED_LIBRARY_SUFFIX}
             HINTS ${SUITESPARSE_DIR} ${CMAKE_INSTALL_PREFIX}/suitesparse/${SUITESPARSE_VERSION}
