...
#find_path(AMD-SCALAPACK_INCLUDE_DIR NAMES scalapack.h
#          HINTS ${AMD-SCALAPACK_DIR}/include ${CMAKE_INSTALL_PREFIX}/scalapack/${AMD-SCALAPACK_VERSION}/include
#          PATHS ${PC_AMD-SCALAPACK_INCLUDEDIR} ${PC_AMD-SCALAPACK_INCLUDE_DIRS})

find_library(AMD-SCALAPACK_LIBRARY NAMES scalapack
             HINTS ${AMD-SCALAPACK_DIR} ${CMAKE_INSTALL_PREFIX}/amd-scalapack/${AMD-SCALAPACK_VERSION}
