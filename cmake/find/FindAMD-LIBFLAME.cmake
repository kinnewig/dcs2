...
find_path(AMD-LIBFLAME_INCLUDE_DIR NAMES FLAME.h
          HINTS ${AMD-LIBFLAME_DIR} ${CMAKE_INSTALL_PREFIX}/amd-libflame/${AMD-LIBFLAME_VERSION}
          PATHS ${PC_AMD-LIBFLAME_INCLUDEDIR} ${PC_AMD-LIBFLAME_INCLUDE_DIRS}
          PATH_SUFFIXES include include/libflame
        )

find_library(AMD-LIBFLAME_LIBRARY NAMES libflame${CMAKE_SHARED_LIBRARY_SUFFIX}
             HINTS ${AMD-LIBFLAME_DIR} ${CMAKE_INSTALL_PREFIX}/amd-libflame/${AMD-LIBFLAME_VERSION}
