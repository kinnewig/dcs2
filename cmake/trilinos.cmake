...
if(TRILINOS_FOUND)
  ...
  set(trilinos_cmake_args
    ...
    -D   MueLu_ENABLE_Tpetra=ON 
    -D   MueLu_ENABLE_Epetra=OFF 
    -D Trilinos_ENABLE_OpenMP:BOOL=OFF 
    -D Trilinos_ENABLE_Sacado:BOOL=ON 
    -D Trilinos_ENABLE_Sacado:BOOL=ON 
    -D Trilinos_ENABLE_ShyLU_DD:BOOL=ON 
    -D   ShyLU_DD_ENABLE_ShyLU_DDCore=OFF 
    -D   ShyLU_DD_ENABLE_TESTS:BOOL=OFF
    -D   ShyLU_DD_ENABLE_ShyLU_DDFROSch=ON 
    -D     ShyLU_DDFROSch_ENABLE_Tpetra=ON 
    -D     ShyLU_DDFROSch_ENABLE_Epetra=OFF 
    -D Trilinos_ENABLE_Stratimikos:BOOL=ON 
    -D Trilinos_ENABLE_Thyra:BOOL=ON 
    -D Trilinos_ENABLE_Tpetra:BOOL=ON 
    -D Trilinos_ENABLE_ROL:BOOL=ON 
    -D Trilinos_ENABLE_Xpetra:BOOL=ON 
    -D   Xpetra_ENABLE_Tpetra:BOOL=ON 
  ...
  if (DEFINED BOOST_DIR)
    ...
    if(EXISTS "${BOOST_DIR}/lib")
      list(APPEND trilinos_cmake_args "-D Boost_LIBRARY_DIRS:PATH=${BOOST_DIR}/lib")
    elseif(EXISTS "${BOOST_DIR}/lib64")
      list(APPEND trilinos_cmake_args "-D Boost_LIBRARY_DIRS:PATH=${BOOST_DIR}/lib64")
    else()
      message(FATAL_ERROR "Could not find the path to the Boost library, tested: ${BOOST_DIR}/lib64 and ${BOOST_DIR}/lib ")
    endif()
